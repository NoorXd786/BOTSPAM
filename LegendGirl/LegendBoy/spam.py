    ...
    if counts:
        ...
        for _ in range(counts):
            ...
            if ".jpg" in porn or ".png" in porn:
                await Legend.send_photo(chat.id, porn)
